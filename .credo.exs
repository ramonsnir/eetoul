  ...
  configs: [
    %{
      ...
      checks: [
        ...
        # {Credo.Check.Warning.NameRedeclarationByAssignment}, # FIXME uncomment after credo fixes patterns bug #102
        # {Credo.Check.Warning.NameRedeclarationByCase}, # FIXME uncomment after credo fixes patterns bug #102
        # {Credo.Check.Warning.NameRedeclarationByDef}, # FIXME uncomment after credo fixes patterns bug #102
        # {Credo.Check.Warning.NameRedeclarationByFn}, # FIXME uncomment after credo fixes patterns bug #102
